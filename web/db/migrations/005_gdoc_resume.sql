-- Phase 2c: Google Doc-based resume generation

ALTER TABLE master_resume ADD COLUMN doc_id TEXT;
ALTER TABLE master_resume ADD COLUMN doc_layout TEXT;
ALTER TABLE master_resume ADD COLUMN doc_synced_at TEXT;

ALTER TABLE resume_versions ADD COLUMN drive_doc_id TEXT;
...
Respond with ONLY valid JSON matching this exact shape — no markdown, no prose:
{
  ...
  1,
  'Phase 2c: Google Doc template-based resume'
);
